...
t = t.t_meas(ind1:ind2)*fs/fs_play;
y = 20*y.v2(ind1:ind2);
...
wavwrite(y,fs_play,'..\results\log-compression\before_compressed');
wavwrite(real(compressed_y),fs_play,'..\results\log-compression\after_compressed');
